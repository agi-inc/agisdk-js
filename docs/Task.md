...
Example task file: `example/tasks/test.json`

More complex tasks can be found in the Python SDK's task directory:
`../../agisdk/src/agisdk/REAL/browsergym/webclones/v2/tasks/`

## Running Tasks

Tasks can be run using the harness. Basic usage:
